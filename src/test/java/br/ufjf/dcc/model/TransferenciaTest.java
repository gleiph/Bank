...
public class TransferenciaTest {
    ...
    public void shouldThrowExceptionForNegativeValue(){
        ...
        assertThrows(InvalidValueException.class, () ->
                        Transferencia.getInstance(contaOrigem, contaDestino, -1000),
    ...
    public void shouldCreateInstanceForValidTransfer() throws InvalidEmailException {
        ...
        Transferencia instance = Transferencia.getInstance(contaOrigem, contaDestino, 1000);
        assertNotNull(instance, "Expected Transferencia instance to be created for a valid transfer.");
    }
}
